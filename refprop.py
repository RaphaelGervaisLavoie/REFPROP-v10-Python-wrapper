...
(_tcrit, _pcrit, _Dcrit, _zcrit, _t, _D, _p, _e, _h, _s, _A, _G, _cv, _cp, _w,
    _Z, _hjt, _xkappa, _beta,  _d2pdD2,  _dDdt, _dDdp, _spare1,
...
def _loadfile(fpath):
    ...
    if system() == 'Linux':
        ...
        (_rp.SETUPdll, _rp.SETMODdll, _rp.GERG04dll, _rp.SETREFdll,
         ...
         _rp.GIBBSdll, _rp.AGdll, _rp.PRESSdll, _rp.DPDTdll, _rp.DPDTKdll, _rp.DDDPdll,
...
def therm2(t, D, x):
    ...
    return _prop(x = x, D = D, t = t, p = _p.value, e = _e.value, h = _h.value,
            ...
            xkappa = _xkappa.value, beta = _beta.value, 
            d2pdD2 = _d2pdD2.value,  dDdt = _dDdt.value,
            dDdp = _dDdp.value)
...
def dptsatk(icomp, t, kph=2):
    ...
    return _prop(icomp = icomp, t = t, kph = kph, p = _p.value, D = _D.value,
            csat = _csat.value,  ierr = _ierr.value,
